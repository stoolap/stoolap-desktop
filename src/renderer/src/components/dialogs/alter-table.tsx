      ...
      <DialogContent className="sm:max-w-3xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-5 py-2">
          ...
          <div className="space-y-2">
            ...
            {/* Header */}
            <div className="grid grid-cols-[1fr_130px_60px_50px_50px_80px] gap-x-2 px-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">
              <span>Name</span>
              <span>Type</span>
              <span>Dims</span>
                      ...
                      {col.status === "renamed" && (
                        <Tooltip>
                          <TooltipTrigger>
                            <Badge
                              variant="outline"
                              className="text-xs px-1 py-0 text-blue-500 border-blue-500/50 shrink-0"
                            >
                  ...
                  <div className="flex items-center gap-1">
                    {VECTOR_DIM_PRESETS.slice(0, 4).map((d) => (
                      <Badge
                        key={d}
                        variant="outline"
                        className="text-xs px-1.5 py-0 cursor-pointer hover:bg-purple-500/10 hover:border-purple-500/50"
